...
if($_SERVER['REQUEST_METHOD']=='POST'){
 ...
 if($name == '' || $username == '' || $password == '' || $email == '' || $gender == '' || $mobileno == '' ){
 ...
 $sql = "INSERT INTO user_details (first_name,last_name,password,email_id,gender,enrollment_no,mobile_no,clg_name) VALUES('$name','$username','$password','$email','$gender','$enrollmentno','$mobileno','$clgname')";
