...
<div class="grid-form">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="email" name="event_description" placeholder="Event Description" required>
  </div>
            <div class="form-group">
    <label for="exampleInputEmail1">Event Image</label>
    <input type="text" class="form-control" id="email" name="event_img" placeholder="Event Link" required>
  </div>
  <div class="form-group">
